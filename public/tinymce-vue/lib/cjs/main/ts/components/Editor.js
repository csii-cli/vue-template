...
exports.Editor = vue_1.defineComponent({
  ...
  setup: function (props, ctx) {
    ...
    var getContent = function (isMounting) {
      return modelBind
        ? function () {
            return (modelValue === null || modelValue === void 0 ? void 0 : modelValue.value)
              ? modelValue.value
              : ''
          }
        : function () {
    ...
    var initWrapper = function () {
      ...
      var finalInit = __assign(__assign({}, props.init), {
        readonly: props.disabled,
        selector: '#' + elementId,
        plugins: Utils_1.mergePlugins(props.init && props.init.plugins, props.plugins),
